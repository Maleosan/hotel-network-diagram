(function(root,factory){
    ...
    const articles=[
        ...
        ["zoom-pan","Diagram","How to Zoom & Pan?",["Desktop: putar roda mouse untuk zoom, lalu tahan tombol tengah mouse dan drag untuk pan dari area mana pun.","Alternatif desktop: tahan Space lalu drag dengan tombol kiri mouse.","Android: swipe satu jari pada area kosong untuk pan; drag langsung pada device untuk memindahkan device.","Pinch dua jari untuk zoom. Zoom out tersedia sampai 10%."],"Pan dan zoom hanya mengubah tampilan kamera; koordinat device tidak berubah dan tidak memicu autosave diagram."],
